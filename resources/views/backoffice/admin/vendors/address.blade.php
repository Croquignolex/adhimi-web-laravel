@extends('layouts.backoffice.admin.vendor-edit', ['title' => __('general.action.update_address')])
        ...
        <div class="row">
            <div class="col-12 col-sm-12">
                @include('partials.input.text', [
                    'value' => $vendor->defaultAddress?->street_address,
            ...
            <div class="col-12 col-sm-6">
                @include('partials.input.text', [
                   'value' => $vendor->defaultAddress?->street_address_plus,
            ...
            <div class="col-12 col-sm-6">
                @include('partials.input.text', [
                   'value' => $vendor->defaultAddress?->zipcode,
            ...
            <div class="col-12 col-sm-6">
                @include('partials.input.text', [
                   'value' => $vendor->defaultAddress?->phone_number_one,
            ...
            <div class="col-12 col-sm-6">
                @include('partials.input.text', [
                   'value' => $vendor->defaultAddress?->phone_number_two,
            ...
            <div class="col-12 col-sm-6">
                @include('partials.input.ajax-select', [
                    ...
                    'required' => true,
                    'field' => 'country',
                    'value' => $vendor->defaultAddress?->state->country->id,
            ...
            <div class="col-12 col-sm-6">
                @include('partials.input.ajax-select', [
                    ...
                    'required' => true,
                    'field' => 'state',
                    'value' => $vendor->defaultAddress?->state->id,
            ...
            <div class="col-12">
                @include('partials.input.textarea', ['value' => $vendor->defaultAddress?->description])
            </div>
            <div class="col-12">
