                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            @include('partials.input.ajax-select', [
                                               ...
                                               'route' => route('api.organisations.index') . '?free=' . \App\Enums\UserRoleEnum::ShopManager->value,
                                            ])
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            @include('partials.input.ajax-select', [
                                               ...
                                               'route' => route('api.shops.index') . '?free=' . \App\Enums\UserRoleEnum::ShopManager->value,
                                            ])
                                        </div>
                                    </div>
                                    <div class="row">
